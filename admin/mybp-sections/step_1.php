		...
		<div class="hover apipanel" data-equalizer data-equalizer-watch>
			...
			<div class="front" data-equalizer-watch>
				<div class="frontinner" data-equalizer-watch>
					...
					<h3 class="attn">In order to protect <?php echo $local_host; ?>, you must first obtain a free API
						key.</h3>
					...
					<form action="" class="row emailholder" method="post">
						...
						<div class="columns large-8 medium-8">
							<label for="email_address"><input type="email" name="email_address"
							                                  placeholder="youremail@domain.com" id="brute_get_api_key"
							                                  class="email"
			...
			<div class="back" data-equalizer-watch>
				<div class="backinner" data-equalizer-watch>
					...
					<h4 class="attn">Remember you need a unique API key for every site. <br/>If you need a new one <a
