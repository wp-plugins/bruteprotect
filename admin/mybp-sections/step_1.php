    ...
    <div id="bruteapi" class="new_ui row">
        ...
        <div class="brutecontainer columns large-12">
            ...
            <div class="hover apipanel" data-equalizer data-equalizer-watch>
                ...
                <div class="generate_api_key" data-equalizer-watch>
                    <div class="frontinner" data-equalizer-watch>
                        ...
                        <form action="" class="row emailholder" method="post">
                            ...
                            <?php $nonce_get_key = wp_create_nonce( 'brute_get_key' ); ?>
                            <input type="hidden" name="brute_nonce" value="<?php echo $nonce_get_key; ?>"/>

                            <div class="columns large-8 medium-8">
                                <label for="email_address"><input type="email" name="email_address"
                                                                  placeholder="youremail@domain.com"
                                                                  id="brute_get_api_key"
                                                                  class="email"
                                                                  value="<?php echo $current_user->user_email; ?>"/></label>
                            </div>
                            <div class="columns large-4 medium-4">
                                <input type="submit" name="submit_email" value="Start protecting my site"
                                       class="submit_email "/> <!-- move to step 2 -->
                            </div>

                        </form>

                        <a href="#" class="already" id="alreadyapi">I already have an API key
                            for <?php echo $local_host; ?></a>
                ...
                <div class="enter_api_key" data-equalizer-watch>
                    <div class="backinner" data-equalizer-watch>
                        ...
                        <form id="api_retrieve" class="row emailholder" action="" method="post">
                            ...
                            <?php $nonce_update_key = wp_create_nonce( 'brute_update_key' ); ?>
                            <input type="hidden" name="brute_nonce" value="<?php echo $nonce_update_key; ?>"/>

                            <div class="columns large-8 medium-8">
                                <label for="unique_api"><input type="text" name="brute_api_key" placeholder=""
                                                               id="brute_get_api_key" class="apifield"/></label>
                            </div>
                            <div class="columns large-4 medium-4">
                                <input type="submit" name="submit_api" value="Start protecting my site"
                                       class="submit_api "/> <!-- move to step 2 -->
                            </div>

                        </form>


                        <h4 class="attn">Remember you need a unique API key for every site. <br/>If you need a new one
                            <a
                                href="#" id="flip_return2" class="">click here.</a></h4>
            ...
            <script type="text/javascript">
	            ...
	            jQuery(".enter_api_key").hide();

                /**
                 * Handler for fliping over to the api field
                 */
                jQuery('#alreadyapi').on("click", function () {
                    jQuery(".enter_api_key").show();
	                jQuery(".generate_api_key").hide();
                });
