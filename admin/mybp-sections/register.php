	...
	<div class="clearfix" data-equalizer>
		...
		<div class="columns large-6" data-equalizer-watch>
			...
			<form action="" method="post" class="regform" id="link_site_form" >
				...
				<a href="<?php echo MYBP_URL; ?>dashboard/get_token" id="get_token" style="display: inline-block; padding-top: 22px;"><em>Generate your access token</em></a>
				...
				<p>Congrats, the <i class="fa fa-check-square "></i> up above means our free brute force protection service, BruteProtect Shield is working.</p>
				<p>Your access token is only required to connect this website to <a href="http://my.bruteprotect.com" target="_blank">my.bruteprotect.com</a>, giving you free access to our pro services, and control of your website from within the BruteProtect dashboard.</p>
				<p>Registration at <a href="http://my.bruteprotect.com" target="_blank">my.bruteprotect.com</a> through WordPress.com is required; just click "Generate your access token" to get started.</p>
