...
?>
<div id="newbutton">
	<a class="btn bfm bfme icon-arrow-right" href="/"
	   onclick="PopupCenter('<?php echo $bruteprotect_host; ?>ui/login/to/<?php echo rawurlencode( $login_url ); ?>/<?php echo $api_key; ?>/<?php echo base64_encode( $redirect ); ?>', 'Secure Login', 400, 300); return false;">
	<span class="btext">
